          ...
          <div className="modal-box">
            ...
            <div className="modal-header">
              ...
              <div className="modal-actions">
                ...
                <span onClick={deleteEvent} style={{ cursor: "pointer", color: "red" }}>
                  🗑️
                </span>
            ...
            {!isEditing ? (
              ...
              <form onSubmit={updateEvent}>
                ...
                <input type="datetime-local" value={editStartDatetime}
                  onChange={(e) => setEditStartDatetime(e.target.value)} />

                <input type="datetime-local" value={editEndDatetime}
