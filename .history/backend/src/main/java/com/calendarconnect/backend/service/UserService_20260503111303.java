        ...
        .map(user -> {
          ...
          Optional<Friendship> friendship =
              friendshipRepository
                  .findByRequesterIdAndAddresseeIdOrAddresseeIdAndRequesterId(
                      currentUserId,
                      user.getId(),
                      currentUserId,
                      user.getId()
          ...
          if (friendship.isPresent()) {
            status = friendship.get().getStatus().name();
          }
