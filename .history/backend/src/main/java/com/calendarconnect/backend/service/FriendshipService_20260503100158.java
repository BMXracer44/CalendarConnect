...
public class FriendshipService {
  ...
  // ================= GET FRIENDS (FIXED + SINGLE VERSION) =================
  ...
  // ================= REMOVE FRIEND (FIXED SAFE VERSION) =================
  public void removeFriend(int userId, int friendId) {

  System.out.println("Removing friend: " + userId + " and " + friendId);

  friendshipRepository
      .deleteByRequesterIdAndAddresseeIdOrAddresseeIdAndRequesterId(
          userId, friendId,
          userId, friendId
      );
}
